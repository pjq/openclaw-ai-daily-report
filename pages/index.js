          ...
          <main>
            {currentReport && (
              <article style={{ background: theme.cardBg, border: `1px solid ${theme.border}`, borderRadius: '8px', padding: '30px', position: 'relative', overflow: 'hidden' }}>
                ...
                <h2 style={{ marginTop: 0, color: theme.primary, fontSize: '1.8rem', textShadow: `0 0 20px ${theme.primary}`, letterSpacing: '2px', borderBottom: `1px solid ${theme.border}`, paddingBottom: '15px', marginBottom: '20px' }}>{currentReport.title}</h2>
                <p style={{ color: theme.secondary, fontSize: '0.85rem', letterSpacing: '2px', marginBottom: '25px' }}>// TIMESTAMP: {currentReport.date} ◇ SYSTEM: ONLINE</p>
